...
// NOLINTBEGIN
inline void
on_kfd_event_dropped_events(rocprofiler_context_id_t      context,
...
inline constexpr auto kfd_event_dropped_events = buffered_domain_definition{
    .meta =
        domain_descriptor{
            .name  = "kfd_event_dropped_events",
            .id    = ROCPROFILER_BUFFER_TRACING_KFD_EVENT_DROPPED_EVENTS,
            .mode  = collection_mode::buffered,
            .group = domain_group{ .name = "kfd_events" },
        },
    .on_records = on_kfd_event_dropped_events
};
