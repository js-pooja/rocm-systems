...
// NOLINTBEGIN
inline void
on_kfd_event_page_fault(rocprofiler_context_id_t      context,
...
inline constexpr auto kfd_event_page_fault = buffered_domain_definition{
    .meta =
        domain_descriptor{
            .name  = "kfd_event_page_fault",
            .id    = ROCPROFILER_BUFFER_TRACING_KFD_EVENT_PAGE_FAULT,
            .mode  = collection_mode::buffered,
            .group = std::nullopt,
        },
    .on_records = on_kfd_event_page_fault
};
