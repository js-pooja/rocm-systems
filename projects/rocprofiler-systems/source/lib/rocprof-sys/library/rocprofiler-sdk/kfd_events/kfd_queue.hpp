...
inline void
on_kfd_queue(typename SdkBackend::buffer_tracing_kfd_event_queue_record_t* record,
             void*                                                         data)
{}

template <typename SdkBackend =
              backends::rocprofiler_sdk::backend<rocprofiler_sdk::wrapper>>
inline constexpr auto kfd_queue = buffered_domain_definition<SdkBackend>{
    .meta =
        domain_descriptor{
            .name  = "kfd_queue",
    ...
    .on_records = buffered_callback_dispatcher<
        ...
        on_kfd_queue<SdkBackend>>::callback
};
