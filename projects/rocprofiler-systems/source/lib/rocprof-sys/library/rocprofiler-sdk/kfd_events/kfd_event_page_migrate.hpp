...
inline void
on_kfd_event_page_migrate(
    typename SdkBackend::buffer_tracing_kfd_event_page_migrate_record_t* record,
    void*                                                                data)
{}

template <typename SdkBackend =
              backends::rocprofiler_sdk::backend<rocprofiler_sdk::wrapper>>
inline constexpr auto kfd_event_page_migrate = buffered_domain_definition<SdkBackend>{
    .meta =
        domain_descriptor{
    ...
    .on_records = buffered_callback_dispatcher<
        SdkBackend, typename SdkBackend::buffer_tracing_kfd_event_page_migrate_record_t,
        on_kfd_event_page_migrate<SdkBackend>>::callback
};
