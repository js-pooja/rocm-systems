...
// NOLINTBEGIN
inline void
on_kfd_event_page_migrate(rocprofiler_context_id_t      context,
...
inline constexpr auto kfd_event_page_migrate = buffered_domain_definition{
    .meta =
        domain_descriptor{
            .name  = "kfd_event_page_migrate",
            .id    = ROCPROFILER_BUFFER_TRACING_KFD_EVENT_PAGE_MIGRATE,
            .mode  = collection_mode::buffered,
            .group = std::nullopt,
        },
    .on_records = on_kfd_event_page_migrate
};
