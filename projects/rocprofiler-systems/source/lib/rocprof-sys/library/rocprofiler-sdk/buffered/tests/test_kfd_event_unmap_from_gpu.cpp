...
// Self-contained stand-in for SdkBackend: kfd_event_unmap_from_gpu<SdkBackend, Externals>
// and on_kfd_event_unmap_from_gpu<SdkBackend, Externals> only ever touch these members.
struct mock_sdk
{
    struct context_id_t
    {
...
// on_kfd_event_unmap_from_gpu<mock_sdk, externals> touches through Externals.
struct agent_t
{
    int         type              = 0;
...
// on_kfd_event_unmap_from_gpu and on_kfd_event_unmap_from_gpu_configure with no-op
