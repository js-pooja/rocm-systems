...
#ifndef ROCJITSU_ISA_ARCH_AMDGPU_CDNA4_MODEL_TARGET_PROVIDER_H_
#define ROCJITSU_ISA_ARCH_AMDGPU_CDNA4_MODEL_TARGET_PROVIDER_H_
...
#endif // ROCJITSU_ISA_ARCH_AMDGPU_CDNA4_MODEL_TARGET_PROVIDER_H_

#ifdef ROCJITSU_GET_ISA_TARGET_DESCRIPTOR
ROCJITSU_GET_ISA_TARGET_DESCRIPTOR(rocjitsu::cdna4::kModelTargetDescriptor)
#endif
